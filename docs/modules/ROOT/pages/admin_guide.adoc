...
:outline: true
:outlinelevels: 3
:page-pdf-filename: administrator-guide.pdf
...
In the {organization} user interface, navigate to menu:Settings[IWAF]. The IWAF Settings page has tabs for *Blocked IPs*, *Blacklisted IPs*,and *Whitelisted IPs*. If you have access to the {organization} API, you can use the {organization} `/tx_api/v1/lists` endpoint to manage the lists.
