...
For an overview of the ThreatX platform, see the https://www.threatx.com/documentation/using-threatx/overview-guide/[ThreatX Managed API and Application Protection Platform Overview Guide].

For security analysts using the ThreatX platform for threat analysis, see the https://www.threatx.com/documentation/using-threatx/threatx-analyst-guide/[ThreatX Managed API and Application Protection Platform Analyst Guide].
...
image:Dashboard-no-bot-1024x666.jpgDashboard-no-bot-1024x666,width=1024,height=666]
...
* link:#administrator-overview[Administrator overview]
* link:#managing-listed-ips[Managing listed IPs]
* link:#managing-risk-based-blocking[Managing Risk-Based Blocking]
* link:#managing-sites-and-site-groups[Managing sites and site groups]
* link:#managing-sensors[Managing sensors]
* link:#configuring-notifications[Configuring notifications]
* link:#receiving-event-logs[Receiving event logs]
* link:#accessing-the-audit-log[Accessing the audit log]
* link:#managing-user-accounts[Managing user accounts]
* link:#generating-and-revoking-api-keys[Generating and revoking API keys]
* link:#generating-and-revoking-sensor-api-keys[Generating and revoking sensor API keys]
* link:#managing-caching[Managing caching]
* link:#managing-rate-limiting[Managing rate limiting]
* link:#managing-rules[Managing rules]
* link:#configuring-single-sign-on-sso[Configuring Single Sign On (SSO)]
* link:#configuring-mutual-tls-mtls-configuration[Configuring Mutual TLS (mTLS) configuration]
* link:#testing-for-vulnerabilities[Testing for Vulnerabilities]
* link:#troubleshooting-sensor-issues[Troubleshooting sensor issues]
