...
:version-txapi: v2
:url-subpath-txapi: tx_api
:url-base-txapi: api.threatx.io
:url-txapi: https://{url-base-txapi}/{url-subpath-txapi}/{version-txapi}
...
****
URL:: `/{url-subpath-txapi}/{version-txapi}/list`
